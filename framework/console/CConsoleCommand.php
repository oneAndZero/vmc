...
abstract class CConsoleCommand extends CComponent
{
	...
	public function run($args)
	{
		...
		if(!empty($options))
			$this->usageError("Unknown options: ".implode(', ',(array)array_keys($options)));
	...
	/**
	 * Reads input via the readline PHP extensions if that's available, or fgets() if readline is not installed.
	 *
