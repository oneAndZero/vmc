        ...
        if ( ($funcs = spl_autoload_functions()) === false ) {
            ...
            foreach ($funcs as $func) {
                if ($buggy && is_array($func)) {
                    ...
                    if ($compat) $func = implode('::',(array)$func);
                }
...
class HTMLPurifier_ContentSets
{
    ...
    public function __construct($modules) {
        ...
        foreach ($this->lookup as $key => $lookup) {
            $this->info[$key] = implode(' | ',(array)array_keys($lookup));
        }
...
class HTMLPurifier_ErrorCollector
{
    ...
    public function getHTMLFormatted($config, $errors = null) {
        ...
        if (empty($errors)) {
            ...
            return '<ul><li>' . implode('</li><li>',(array)$ret) . '</li></ul>';
        }
        ...
        if (is_object($lexer)) {
            ...
            if (is_null($lexer)) { do {
                ...
                if (
                    ...
                    // domxml extensions overrides the default DOM, and is evil
...
class HTMLPurifier_AttrDef_CSS_Color extends HTMLPurifier_AttrDef
{
    ...
    public function validate($color, $config, $context) {
        ...
        if (strpos($color, 'rgb(') !== false) {
            ...
            $new_triad = implode(',',(array)$new_parts);
            $color = "rgb($new_triad)";
        } else {
...
class HTMLPurifier_AttrDef_CSS_Filter extends HTMLPurifier_AttrDef
{
    ...
    public function validate($value, $config, $context) {
        ...
        $ret_parameters = implode(',',(array)$ret_params);
    ...
    public function validate($string, $config, $context) {
        ...
        for ($i = 0, $size = count($bits); $i < $size; $i++) {
            ...
            switch ($stage) {
                ...
                case 2:
                    $font_family =
                        implode(' ',(array)array_slice($bits, $i, $size - $i));
...
class HTMLPurifier_AttrDef_HTML_LinkTypes extends HTMLPurifier_AttrDef
{
    ...
    public function validate($string, $config, $context) {
        ...
        $string = implode(' ',(array)array_keys($ret_lookup));
    ...
    public function validate($string, $config, $context) {
        ...
        if ($config->get('Core.EnableIDNA')) {
            ...
            try {
                ...
                $string = implode('.',(array)$new_parts);
                if (preg_match("/^($domainlabel\.)*$toplabel\.?$/i", $string)) {
                    return $string;
                }
            } catch (Exception $e) {
...
/**
 * Parser that uses PHP 5's DOM extensions (part of the core).
 *
 * In PHP 5, the DOM XML extensions was revamped into DOM and added to the core.
 ...
 * comes into play.
 *
 * @note PHP's DOM extensions does not actually parse any entities, we use
...
class HTMLPurifier_URIFilter_MakeAbsolute extends HTMLPurifier_URIFilter
{
    ...
    public function filter(&$uri, $config, $context) {
        ...
        if ($uri->path === '') {
            ...
            $uri->path = implode('/',(array)$new_stack);
        } else {
            // absolute path, but still we should collapse
            $uri->path = implode('/',(array)$this->_collapseStack(explode('/', $uri->path)));
        }
        // re-combine
