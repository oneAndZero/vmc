 ...
 *
 * Messages for an extensions class (e.g. a widget, a module) can be specially managed and used.
 * In particular, if a message belongs to an extensions whose class name is Xyz, then the message category
 ...
 * the directory that contains the extensions class file. When using Yii::t() to translate an extensions message,
