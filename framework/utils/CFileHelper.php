...
{
	/**
	 * Returns the extensions name of a file path.
	 * For example, the path "path/to/something.php" would return "php".
	 * @param string $path the file path
	 * @return string the extensions name without the dot character.
	 * @since 1.1.2
	 */
	 ...
	 * @param boolean $checkExtension whether to check the file extensions in case the MIME type cannot be determined
	...
	/**
	 * Determines the MIME type based on the extensions name of the specified file.
	 * This method will use a local map between extensions name and MIME type.
	 * @param string $file the file name.
