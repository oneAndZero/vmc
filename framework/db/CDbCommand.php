...
class CDbCommand extends CComponent
{
	...
	public function execute($params=array())
	{
		if($this->_connection->enableParamLogging && ($pars=array_merge($this->_paramLog,$params))!==array())
		{
			...
			$par='. Bound with ' .implode(', ',(array)$p);
		}
		else
			$par='';
	...
	public function select($columns='*', $option='')
	{
		...
		else
		{
			...
			$this->_query['select']=implode(', ',(array)$columns);
		}
		if($option!='')
	...
	public function from($tables)
	{
		...
		else
		{
			...
			$this->_query['from']=implode(', ',(array)$tables);
		}
		return $this;
	}
	...
	public function group($columns)
	{
		...
		else
		{
			...
			$this->_query['group']=implode(', ',(array)$columns);
		}
		return $this;
	}
	...
	public function order($columns)
	{
		...
		else
		{
			...
			$this->_query['order']=implode(', ',(array)$columns);
		}
		return $this;
	}
	...
	public function insert($table, $columns)
	{
		...
		$sql='INSERT INTO ' . $this->_connection->quoteTableName($table)
			. ' (' . implode(', ',(array)$names) . ') VALUES ('
			. implode(', ',(array)$placeholders) . ')';
	...
	public function update($table, $columns, $conditions='', $params=array())
	{
		...
		$sql='UPDATE ' . $this->_connection->quoteTableName($table) . ' SET ' . implode(', ',(array)$lines);
	...
	private function processConditions($conditions)
	{
		...
		if($operator==='OR' || $operator==='AND')
		{
			...
			return $parts===array() ? '' : implode(' '.$operator.' ',(array)$parts);
		}
		...
		if($operator==='IN' || $operator==='NOT IN')
		{
			...
			return $column.' '.$operator.' ('.implode(', ',(array)$values).')';
		}
