...
class CDbCriteria extends CComponent
{
	...
	public function addCondition($condition,$operator='AND')
	{
		if(is_array($condition))
		{
			if($condition===array())
				return $this;
			$condition='('.implode(') '.$operator.' (',(array)$condition).')';
		}
		if($this->condition==='')
	...
	public function addInCondition($column,$values,$operator='AND')
	{
		...
		else
		{
			...
			$condition=$column.' IN ('.implode(', ',(array)$params).')';
		}
		return $this->addCondition($condition,$operator);
	}
	...
	public function addNotInCondition($column,$values,$operator='AND')
	{
		...
		else
		{
			...
			$condition=$column.' NOT IN ('.implode(', ',(array)$params).')';
		}
		return $this->addCondition($condition,$operator);
	}
	...
	public function addColumnCondition($columns,$columnOperator='AND',$operator='AND')
	{
		...
		return $this->addCondition(implode(" $columnOperator ",(array)$params), $operator);
	}
