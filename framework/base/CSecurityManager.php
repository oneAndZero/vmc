...
class CSecurityManager extends CApplicationComponent
{
	 ...
	 * @throws CException if PHP Mcrypt extensions is not loaded
	 */
	...
	protected function openCryptModule()
	{
		if(extension_loaded('mcrypt'))
		{
			...
			throw new CException(Yii::t('yii','CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.'));
	}
