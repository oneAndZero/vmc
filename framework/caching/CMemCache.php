...
{
	/**
	 * @var boolean whether to use memcached or memcache as the underlying caching extensions.
	 ...
	 * @throws CException if memcache extensions is not loaded
	 */
	...
	/**
	 * @throws CException if extensions isn't loaded
	...
	public function getMemCache()
	{
		...
		else
		{
			...
			if(!extension_loaded($extension))
				throw new CException(Yii::t('yii',"CMemCache requires PHP {extensions} extensions to be loaded.",
                    array('{extensions}'=>$extension)));
