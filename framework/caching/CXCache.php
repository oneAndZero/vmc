 ...
 *
 * To use this application component, the XCache PHP extensions must be loaded.
...
class CXCache extends CCache
{
	 ...
	 * @throws CException if memcache extensions is not loaded or is disabled.
	 */
	public function init()
	{
		parent::init();
		if(!function_exists('xcache_isset'))
			throw new CException(Yii::t('yii','CXCache requires PHP XCache extensions to be loaded.'));
	}
