 ...
 *
 * To use this application component, the Zend Data Cache PHP extensions must be loaded.
 *
...
class CZendDataCache extends CCache
{
	 ...
	 * @throws CException if Zend Data Cache extensions is not loaded.
	 */
	public function init()
	{
		parent::init();
		if(!function_exists('zend_shm_cache_store'))
			throw new CException(Yii::t('yii','CZendDataCache requires PHP Zend Data Cache extensions to be loaded.'));
	}
