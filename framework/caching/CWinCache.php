 ...
 *
 * To use this application component, the WinCache PHP extensions must be loaded.
 *
...
class CWinCache extends CCache {
	 ...
	 * It checks the availability of WinCache extensions and WinCache user cache.
	 * @throws CException if WinCache extensions is not loaded or user cache is disabled
	 */
	public function init()
	{
		parent::init();
		if(!extension_loaded('wincache'))
			throw new CException(Yii::t('yii', 'CWinCache requires PHP wincache extensions to be loaded.'));
