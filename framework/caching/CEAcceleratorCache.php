 ...
 *
 * To use this application component, the eAccelerator PHP extensions must be loaded.
 *
...
class CEAcceleratorCache extends CCache
{
	 ...
	 * @throws CException if eAccelerator extensions is not loaded, is disabled or the cache functions are not compiled in.
	 */
	public function init()
	{
		parent::init();
		if(!function_exists('eaccelerator_get'))
			throw new CException(Yii::t('yii','CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.'));
	}
