 ...
 * @property string $extensionName The file extensions name for {@link name}.
 * The extensions name does not include the dot character. An empty string
 * is returned if {@link name} does not have an extensions name.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @version $Id$
 * @package system.web
...
class CUploadedFile extends CComponent
{
	...
	/**
	 * @return string the file extensions name for {@link name}.
	 * The extensions name does not include the dot character. An empty string
	 * is returned if {@link name} does not have an extensions name.
	 */
