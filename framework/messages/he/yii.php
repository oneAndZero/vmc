...
return array (
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => 'CEAcceleratorCache דורש את התוסף של PHP בשם eAccelerator שיהיה מותקן, פעיל או מקומפל עם ערך "--with-eaccelerator-shared-memory".',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'CZendDataCache דורש תוסף ב PHP בשם Zend Data Cache שיהיה מותקן ופעיל.',
  ...
  'CMemCache requires PHP memcache extensions to be loaded.' => '@@CMemCache דורש תוסף בשם memcache של PHP כדי לתפקד.@@',
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'שימוש במטמון מסוג CApcCache דורש שהתוסף APC של PHP יהיה מותקן ומופעל.',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'CSecurityManager דורש תוסף בשם mcrypt של PHP כדי לתפקד.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'CXCache דורש תוסף בשם XCache של PHP כדי לתפקד.',
  ...
  'File upload was stopped by extensions.' => 'העלאת הקובץ הופסקה על ידי גורם שלישי.',
