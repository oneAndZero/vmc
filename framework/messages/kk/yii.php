...
return array (
  ...
  'CMemCache requires PHP {extensions} extensions to be loaded.' => 'CMemCache өз жұмысы үшін PHP {extensions} жүктелуін талап етеді.',
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'CApcCache өз жұмысы үшін іске қосылған PHP APC кеңейтуін сұрайды.',
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => 'CEAcceleratorCache жұмысы үшін іске қосылған PHP eAccelerator кеңейтуі керек. Ол іске қосылған немесе "--with-eaccelerator-shared-memory" опциясымен компиляцияланған болуы тиіс.',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'Мәліметті шифрлеу мүмкіндігін қолдану үшін CSecurityManager компонентіне mcrypt PHP кеңейтуі керек.',
  ...
  'CWinCache requires PHP wincache extensions to be loaded.' => 'CWinCache жұмысы үшін жұмысқа жүктелген wincache кеңейтуі керек.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'CXCache компонентінің жұмысы үшін жұмысқа жүктелген XCache PHP кеңейтуі керек.',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'CZendDataCache жұмысы үшін PHP Zend Data Cache кеңейтуі жұмысқа жүктелген болуы тиіс.',
  ...
  'File upload was stopped by extensions.' => 'Файлды жүктеу үрдісін кеңейту тоқтатқан.',
