...
return array (
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'CApcCache نیاز به PHP apc extensions دارد برای لود شدن',
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => 'CEAcceleratorCache به اکستنشن PHP eAccelerator احتیاج دارد برای لود شدنو فعال شدن با گزینه "--with-eaccelerator-shared-memory"',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'CSecurityManager به اکستنشن PHP mcrypt نیاز دارد که لود شود به منظور استفاده از داده های رمزگذاری شده',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'CXCache به اکستنشن PHP XCache نیاز دارد که لود شود',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'CZendDataCache به اکستنشن PHP Zend Data Cache نیاز دارد که لود شود',
  ...
  'File upload was stopped by extensions.' => 'آپلود فایل توسط اکستنشن متوقف شد',
