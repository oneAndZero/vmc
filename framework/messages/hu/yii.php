...
'CApcCache requires PHP apc extensions to be loaded.' => 'A CApcCache használatához szükség van a PHP apc bővítményére.',
...
'CMemCache requires PHP memcache extensions to be loaded.' => 'CMemCache használatához előbb be kell tölteni a PHP memcache kiterjesztését.',
...
'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'A CSecurityManager használatához az mcrypt PHP kiterjesztésnek betöltve kell lennie, hogy az adat titkosítás használható legyen.',
...
'CXCache requires PHP XCache extensions to be loaded.' => 'CXCache használatához előbb be kell tölteni a PHP XCache kiterjesztését.',
...
'File upload was stopped by extensions.' => 'Fájl feltöltés bővítmény által leállítva.',
