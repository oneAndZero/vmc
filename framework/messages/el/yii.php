...
return array (
  ...
  'CMemCache requires PHP {extensions} extensions to be loaded.' => 'Το CMemCache απαιτεί την PHP επέκταση {extensions} να έχει φορτωθεί.',
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'Το CApcCache απαιτεί την επέκταση apc της PHP να έχει φορτωθεί.',
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => 'Το CEAcceleratorCache απαιτεί η επέκταση PHP eAccelerator να είναι φορτωμένη, ενεργοποιημένη ή μεταγλωττισμένη με την επιλογή "--with-eaccelerator-shared-memory".',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'Το CSecurityManager απαιτεί να έχει φορτωθεί η επέκταση mcrypt της PHP προκειμένου να χρησιμοποιηθεί το χαρακτηριστικό κρυπτογράφησης των δεδομένων.',
  ...
  'CWinCache requires PHP wincache extensions to be loaded.' => 'Το CWinCache απαιτεί να έχει φορτωθεί η επέκταση wincache της PHP.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'Το CXCache απαιτεί να έχει φορτωθεί η επέκταση XCache της PHP.',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'Το CZendDataCache απαιτεί να έχει φορτωθεί η επέκταση Zend Data Cache της PHP.',
  ...
  'File upload was stopped by extensions.' => 'Η αποστολή του αρχείου διακόπηκε από επέκταση.',
