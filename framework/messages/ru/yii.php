...
return array (
  ...
  'CMemCache requires PHP {extensions} extensions to be loaded.' => 'CMemCache требуется загруженное расширение PHP {extensions}.',
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'CApcCache требует загруженного расширения PHP APC.',
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => 'Для работы CEAcceleratorCache требуется загруженное расширение PHP eAccelerator. Оно должно быть включено или скомпилировано с опцией "--with-eaccelerator-shared-memory".',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'Для использования возможности шифрования данных компоненту CSecurityManager требуется PHP-расширение mcrypt.',
  ...
  'CWinCache requires PHP wincache extensions to be loaded.' => 'Для работы CWinCache требуется загруженное расширение wincache.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'Для работы компонента CXCache необходимо PHP-расширение XCache.',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'Для работы CZendDataCache необходимо расширение PHP Zend Data Cache.',
  ...
  'File upload was stopped by extensions.' => 'Загрузка файла прервана расширением.',
