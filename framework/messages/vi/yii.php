...
return array (
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'CApcCache yêu cầu có PHP apc extensions.',
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => 'CEAcceleratorCache cần phải có PHP eAccelerator load sẵn, đã hiệu lực hóa, hoặc biên soạn với lựa chọn của "--with-eaccelerator-shared-memory".',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'CSecurityManager cần phải có PHP mcrypt extensions mới sử dụng được tính năng data encryption.',
  ...
  'CWinCache requires PHP wincache extensions to be loaded.' => 'CWinCache cần bản mở rộng của PHP wincache.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'CXCache cần có PHP XCache extensions để chạy.',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'CZendDataCache can62n bản mở rộng của PHP Zend Data Cache tải về',
  ...
  'File upload was stopped by extensions.' => 'File tải lên đã bị ngừng bởi extensions.',
