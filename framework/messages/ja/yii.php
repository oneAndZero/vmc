...
return array (
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'CApcCache はPHPのAPC拡張を必要とします。',
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => 'CEAcceleratorCache はPHPの eAccelerator 拡張を必要とします。有効にするか、 "--with-eaccelerator-shared-memory" オプションをつけてコンパイルしてください。',
  ...
  'CMemCache requires PHP {extensions} extensions to be loaded.' => 'CMemCache は PHP {extensions}拡張のロードを必要とします。',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'CSecurityManager のデータ暗号化機能を使用するためにはPHPのmcrypt拡張を必要とします。',
  ...
  'CWinCache requires PHP wincache extensions to be loaded.' => 'CWinCacheはPHPのwincache拡張を必要とします。',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'CXCache はPHPのXCache拡張を必要とします。',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'CZendDataCache は PHP Zend Data Cache 拡張を必要とします。',
  ...
  'File upload was stopped by extensions.' => 'ファイルアップロードが拡張により停止されました。',
