...
return array (
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'CApcCache zahtjeva da je učitan PHP APC dodatak.',
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => 'CEAcceleratorCache zahtjeva, da PHP eAccelerator dodatak je učitan i aktiviran ili sa kompajlira sa opcijom "--with-eaccelerator-shared-memory".',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'CSecurityManager zahtjeva da PHP mcrypt ekstenzija bude uključena da bi se koristila mogućnost enkripcije podataka.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'CXCache zahtjeva da ekstenzija PHP XCache bude učitana.',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'CZendDataCache zahtjeva da ekstenzija PHP Zend Cache bude učitana.',
  ...
  'Extension path "{path}" does not exist.' => 'Put dodataka (extensions path) "{path}" ne postoji.',
  'Failed to write the uploaded file "{file}" to disk.' => 'Neuspješno snimanje podignutog fajla (uploaded file)  "{file}" na disk.',
  'File upload was stopped by extensions.' => 'Podizanje fajla (file upload) je zaustavljeno od strane ekstenzije.',
