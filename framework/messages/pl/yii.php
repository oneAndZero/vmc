...
return array (
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'CApcCache wymaga załadowanego rozszerzenia PHP apc.',
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => 'CEAcceleratorCache wymaga załadowanego, dostępnego lub skompilowanego z opcją "--with-eaccelerator-shared-memory" rozszerzenia PHP eAccelerator',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'Do załadowania CSecurityManager wymagane jest rozszerzenie PHP mcrypt .',
  ...
  'CWinCache requires PHP wincache extensions to be loaded.' => 'CWinCache wymaga załadowanego rozszerzenia PHP wincache.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'CXCache wymaga załadowanego rozszerzenie PHP XCache.',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'CZendDataCache wymaga załadowanego rozszerzenia PHP Zend Data Cache.',
  ...
  'File upload was stopped by extensions.' => 'Przesyłanie pliku zostało zatrzymane przez rozszerzenie.',
