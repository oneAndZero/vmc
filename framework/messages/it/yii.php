...
return array (
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'CXCache richiede che l\'estensione XCache di PHP sia caricata.',
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'CApcCache richiede che l\'estensione apc di PHP sia caricata.',
  ...
  'CMemCache requires PHP memcache extensions to be loaded.' => 'CMemCache richiede che l\'estensione memcache di PHP sia caricata.',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'CSecurityManager richiede che l\'estensione mcrypt di PHP sia caricata per utilizzare l\'opzione di crittografia dei dati.',
  ...
  'File upload was stopped by extensions.' => 'Carimento del file "{file}" interrotto a causa dell\'estensione.',
