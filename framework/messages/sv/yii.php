...
return array (
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'CApcCache kräver att PHP apc-tillägg har laddats.',
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => 'CEAcceleratorCache kräver att PHP-tillägget eAccelerator är laddat, aktiverat eller kompilerat med alternativet "--with-eaccelerator-shared-memory".',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'CSecurityManager kräver att PHP mcrypt-tillägget om datakryptering skall användas.',
  ...
  'CWinCache requires PHP wincache extensions to be loaded.' => 'CWinCache kräver att PHP-tillägget wincache har laddats.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'CXCache kräver att PHP XCache-tillägget är laddat.',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'CZendDataCache kräver att PHP-tillägget Zend Data Cache är laddat.',
  ...
  'File upload was stopped by extensions.' => 'Uppladdning av fil stoppades av tillägg.',
