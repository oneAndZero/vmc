...
return array (
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'CApcCache krever at PHP utvidelsen APC er lastet.',
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => 'CEAcceleratorCache krever at PHP eAccelerator utvidelsen er lastet, aktivert eller kompilert med "--with-eaccelerator-shared-memory".',
  ...
  'CMemCache requires PHP memcache extensions to be loaded.' => 'CMemCache krever PHP memcache utvidelse for å lastes.',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'CSecurityManager krever PHP mcrypt tillegget for å lastes for å kryptere data.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'CXCache krever at PHP tillegget XCache  er lastet.',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'CZendDataCache krever at PHP tillegget Zend Data Cache  er lastet.',
  ...
  'File upload was stopped by extensions.' => 'Opplasting av fil ble stoppet pga filtype.',
