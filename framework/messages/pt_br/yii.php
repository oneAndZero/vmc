...
return array (
  ...
  'CMemCache requires PHP memcache extensions to be loaded.' => '@@CMemCache exigue que a extensão PHP memcache tenha sido carregada.@@',
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'CApcCache requer a extensão PHP APC para ser carregado.',
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => 'CEAcceleratorCache exige que a extensão PHP eAccelerator tenha sido carregada, habilitada ou compilada com a opção "--with-eaccelerator-shared-memory".',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'CSecurityManager requer a extensão PHP mcrypt para ser carregado em ordem para user propriedades de criptografia de dados.',
  ...
  'CWinCache requires PHP wincache extensions to be loaded.' => 'CWinCache exige que a extensão PHP wincache tenha sido carregada.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'CXCache requer que a extensão PHP XCache seja carregada.',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'CZendDataCache exige que a extensão PHP Zend Data Cache tenha sido carregada.',
  ...
  'File upload was stopped by extensions.' => 'Upload de arquivo foi parado pela extensão.',
