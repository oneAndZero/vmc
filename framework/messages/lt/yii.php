...
return array (
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'CApcCache reikalingas įkeltas PHP plėtinys apc.',
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => 'CEAcceleratorCache reikalingas įkeltas, įjungtas arba su parametru „--with-eaccelerator-shared-memory“ sukompiliuotas PHP plėtinys eAccelerator.',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'Norint naudoti CSecurityManager duomenų šifravimui, reikalingas įkeltas PHP plėtinys mcrypt.',
  ...
  'CWinCache requires PHP wincache extensions to be loaded.' => 'CWinCache reikalingas įkeltas PHP plėtinys wincache.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'CXCache reikalingas įkeltas PHP plėtinys XCache.',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'CZendDataCache reikalingas įkeltas PHP plėtinys Zend Data Cache.',
  ...
  'File upload was stopped by extensions.' => 'Plėtinys neleido nusiųsti failo.',
