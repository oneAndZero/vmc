...
return array (
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'CApcCachenin başlatılması için PHP apc eklentisi gerekli',
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => 'CEAcceleratorCache yüklenmesi için PHP eAccelerator uzantısı gerekli, "--with-eaccelerator-shared-memory" opsiyonu ile aktif edilebilir veya derlenebilir.',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'CSecurityManager data şifreleme özelliğini kullanabilmek için PHP mcrypt uzantısına ihtiyaç duyar.',
  ...
  'CWinCache requires PHP wincache extensions to be loaded.' => 'CWinCache PHP wincache uzantısına ihtiyaç duyar.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'CXCache PHP XCache uzantısına ihtiyaç duyar.',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'CZendDataCache PHP Zend Data Cache uzantısına ihtiyaç duyar.',
  ...
  'File upload was stopped by extensions.' => 'Karşıya dosya yükleme işlemi bir uzantı tarafından durduruldu.',
