 ...
 */
return array (
  'In order to use MIME-type validation provided by CFileValidator fileinfo PECL extensions should be installed.' => 'Pre využitie kontroly MIME-typ súboru v rámci validátora CFileValidator je potrebné mať inštalované PECL rozšírenie fileinfo.',
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'CApcCache vyžaduje prítomnosť knižnice APC.',
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => 'CEAcceleratorCache vyžaduje prítomnosť PHP rozšírenia eAccelerator, alebo mať zapnutú podporu s nastavením "--with-eaccelerator-shared-memory".',
  ...
  'CMemCache requires PHP {extensions} extensions to be loaded.' => 'CMemCache vyžaduje nahraté rozšírenie PHP {extensions}.',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'CSecurityManager vyžaduje prítomnosť PHP rozšírenia MCrypt pre účely využitia šifrujúcich funkcií.',
  ...
  'CWinCache requires PHP wincache extensions to be loaded.' => 'CWinCache vyžaduje prítomnosť knižnice PHP wincache.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'CXCache vyžaduje prítomnosť PHP knižnice XCache.',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'CZendDataCache vyžaduje prítomnosť PHP knižnice Zend Data Cache.',
  ...
  'File upload was stopped by extensions.' => 'Nahrávanie súboru bolo prerušené rozšírením.',
