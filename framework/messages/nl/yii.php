...
return array (
  ...
  'CMemCache requires PHP {extensions} extensions to be loaded.' => 'CMemCache vereist dat de PHP {extensions} extensie geladen is',
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'Voor het gebruik van CApcCache moet de apc extensie geladen zijn.',
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => 'Voor het gebruik van CEAcceleratorCache moet de PHP eAccelerator extensie geladen, aangezet of gecompileerd zijn met de "--with-eaccelerator-shared-memory" optie.',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'CSecurityManager vereist de PHP mcrypt extensie om de data te kunnen versleutelen.',
  ...
  'CWinCache requires PHP wincache extensions to be loaded.' => 'Voor het gebruik van CWinCache moet de PHP wincache extensie geladen zijn.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'Voor het gebruik van CXCache moet de XCache extensie geladen zijn.',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'Voor het gebruik van CZendDataCache moet de PHP Zend Data Cache extensie geladen zijn.',
  ...
  'File upload was stopped by extensions.' => 'De bestandsupload werd gestopt door de extensie.',
