...
return array (
  ...
  'CMemCache requires PHP {extensions} extensions to be loaded.' => 'CMemCache потребує завантаженого розширення PHP {extensions}.',
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'CApcCache вимагає завантаженого розширення PHP APC.',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'Для використання можливості шифрування даних компоненту CSecurityManager потрібне PHP-розширення mcrypt.',
  ...
  'CWinCache requires PHP wincache extensions to be loaded.' => 'Для роботи CWinCache потрібно завантажене розширення wincache.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'Для роботы компонента CXCache потрібне PHP-розширення XCache.',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'Для роботы CZendDataCache потрібне PHP-розширення PHP Zend Data Cache.',
  ...
  'File upload was stopped by extensions.' => 'Завантаження файлу перервано розширенням.',
