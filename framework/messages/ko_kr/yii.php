...
return array (
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'CApcCache은 PHP APC 확장이 필요합니다.',
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => 'CEAcceleratorCache은 PHP eAccelerator 확장이 필요합니다. "--with-eaccelerator-shared-memory" 옵션을 붙여 컴파일하십시오.',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'CSecurityManager 데이터 암호화 기능을 사용하기 위해서는 PHP의 mcrypt 확장을 필요로합니다.',
  ...
  'CWinCache requires PHP wincache extensions to be loaded.' => 'CWinCache는 PHP의 wincache 확장이 필요합니다.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'CXCache은 PHP XCache 확장을 필요로합니다.',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'CZendDataCache는 PHP Zend Data Cache 확장이 필요합니다.',
  ...
  'File upload was stopped by extensions.' => '파일 업로드가 확장(?)에 의해서 중지되었습니다.',
