...
return array (
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'CApcCache vyžaduje přítomnost knihovny APC.',
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => 'CEAcceleratorCache vyžaduje přítomnost PHP rozšíření eAccelerator, nebo mít zapnutou podporu s nastavením "--with-eaccelerator-shared-memory".',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'CSecurityManager vyžaduje přítomnost PHP rozšíření MCrypt pro účely využití šifrujících funkcí.',
  ...
  'CWinCache requires PHP wincache extensions to be loaded.' => 'CWinCache vyžaduje přítomnost knihovny PHP wincache.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'CXCache vyžaduje přítomnost PHP knihovny XCache.',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'CZendDataCache vyžaduje přítomnost PHP knihovny Zend Data Cache.',
  ...
  'File upload was stopped by extensions.' => 'Nahrávání souboru bylo přerušené rozšířením.',
