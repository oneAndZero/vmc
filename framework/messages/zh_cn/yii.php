...
return array (
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => 'CEAcceleratorCache需要PHP的Accelerator扩展被调用，并且使用 "--with-eaccelerator-shared-memory" 选项启用或者编译。',
  'CTypedMap<{type}> can only hold objects of {type} class.' => 'CTypedMap<{type}>仅支持{type}类的对象。',
  'CWinCache requires PHP wincache extensions to be loaded.' => 'CWinCache需要PHP的wincache扩展被调用。',
  ...
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'CZendDataCache需要PHP的Zend Data Cache扩展被调用。',
  ...
  'CMemCache requires PHP memcache extensions to be loaded.' => '@@CMemCache 要求 PHP memcache extensions 必须先被载入.@@',
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'CApcCache 要求 PHP apc extensions 必须先被载入.',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'CSecurityManager 要求 PHP mcrypt extensions 必须先被载入以便使用资料加密功能.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'CXCache 要求 PHP XCache extensions 必须先被载入.',
  ...
  'File upload was stopped by extensions.' => '文件上传被 extensions 所停止.',
