...
return array (
  ...
  'CWinCache requires PHP wincache extensions to be loaded.' => 'CWinCache impose que l\'extensions PHP wincache soit chargée.',
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'L\'extensions PHP apc doit être chargée pour pouvoir utiliser CApcCache.',
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => 'CEAcceleratorCache a besoin de l\'extensions PHP eAccelerator pour se charger, activée ou compilée avec l\'option « --with-eaccelerator-shared-memory ».',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'L\'extensions PHP mcrypt doit être chargée pour pouvoir utiliser CSecurityManager et activer les fonctionnalités de cryptage.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'L\'extensions PHP XCache doit être chargée pour pouvoir utiliser CXCache.',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'CZendDataCache nécessite l\'extensions PHP Zend Data Cache pour être chargé.',
  ...
  'Extension path "{path}" does not exist.' => 'Le chemin d\'accès « {path} » de l\'extensions n\'existe pas.',
  'Failed to write the uploaded file "{file}" to disk.' => 'Impossible d\'écrire le fichier téléchargé « {file} » sur le disque',
  'File upload was stopped by extensions.' => 'Le téléchargement a été stoppé apr extensions.',
