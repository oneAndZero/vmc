...
return array (
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'CApcCache perlu extensions APC PHP di-load.',
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => 'CEAcceleratorCache perlu extensions eAccelerator PHP di-load, aktifkan, atau dikompilasi dengan opsi "--with-eaccelerator-shared-memory".',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'CSecurityManager memerlukan extensions PHP mcrypt di-load agar dapat menggunakan fitur enkripsi data.',
  ...
  'CWinCache requires PHP wincache extensions to be loaded.' => 'CWinCache perlu extensions PHP wincache di-load.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'CXCache memerlukan extensions PHP XCache sudah di-load.',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'CZendDataCache perlu extensions PHP Zend Data Cache di-load.',
  ...
  'Extension path "{path}" does not exist.' => 'Path extensions "{path}" tidak ada.',
  ...
  'File upload was stopped by extensions.' => 'Upload file dihentikan oleh extensions.',
  ...
  'The file "{file}" cannot be uploaded. Only files with these extensions are allowed: {extensions}.' => 'File "{file}" tidak bisa di-upload. Hanya file dengan extensions ini yang diijinkan: {extensions}.',
