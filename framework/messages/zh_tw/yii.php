...
return array (
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'CApcCache 要求 PHP apc extensions 必須先被載入.',
  ...
  'CMemCache requires PHP memcache extensions to be loaded.' => 'CMemCache 要求 PHP memcache extensions 必須先被載入.',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'CSecurityManager 要求 PHP mcrypt extensions 必須先被載入以便使用資料加密功能.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'CXCache 要求 PHP XCache extensions 必須先被載入.',
  ...
  'File upload was stopped by extensions.' => '檔案上傳被 extensions 所停止.',
