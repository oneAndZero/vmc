...
return array (
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'CApcCache erfordert, dass die PHP APC Erweiterung geladen wurde.',
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => 'CEAcceleratorCache erfordert, dass die PHP eAccelerator Erweiterung geladen und aktiviert oder mit der "--with-eaccelerator-shared-memory"-Option kompiliert wurde.',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'CSecurityManager erfordert, dass die PHP mcrypt Erweiterung geladen wurde, um das Datenverschlüsselungs-Feature nutzen zu können.',
  ...
  'CWinCache requires PHP wincache extensions to be loaded.' => 'CWinCache erfordert, dass die PHP Wincache Erweiterung geladen wurde.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'CXCache erfordert, dass die PHP XCache Erweiterung geladen wurde.',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'CZendDataCache efordert, dass die PHP Zend Data Cache Erweiterung geladen wurde.',
  ...
  'File upload was stopped by extensions.' => 'Datei-Upload wurde von einer Erweiterung angehalten.',
