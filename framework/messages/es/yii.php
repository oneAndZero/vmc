...
return array (
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => 'CEAcceleratorCache requiere la extensión eAccelerator de PHP para ser cargada, activada o cargada con la opción "--with-eaccelerator-shared-memory".',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => 'CZendDataCache requiere la extensión PHP Zend Data Cache para poder ser cargada.',
  ...
  'CMemCache requires PHP memcache extensions to be loaded.' => 'CMemCache requiere que la extensión memcache de PHP se encuentre cargada.',
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'CApcCache requiere que la extensión apc de PHP se encuentre cargada.',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'CSecurityManager requiere que la extensión mcrypt de PHP sea cargada para utilizar la opción de encriptación de datos.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'CXCache requiere la extensión XCache de PHP para ser cargado',
  ...
  'File upload was stopped by extensions.' => 'El upload de archivo fue terminado debido a su extensión.',
