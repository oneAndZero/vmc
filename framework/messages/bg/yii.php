...
return array (
  ...
  'CEAcceleratorCache requires PHP eAccelerator extensions to be loaded, enabled or compiled with the "--with-eaccelerator-shared-memory" option.' => '',
  'CTypedMap<{type}> can only hold objects of {type} class.' => '',
  'CWinCache requires PHP wincache extensions to be loaded.' => '',
  'CWinCache user cache is disabled. Please set wincache.ucenabled to On in your php.ini.' => '',
  'CZendDataCache requires PHP Zend Data Cache extensions to be loaded.' => '',
  ...
  'CApcCache requires PHP apc extensions to be loaded.' => 'CApcCache изисква да бъде заредено PHP apc разширението.',
  ...
  'CSecurityManager requires PHP mcrypt extensions to be loaded in order to use data encryption feature.' => 'CSecurityManager изисква наличието на PHP допълнението mcrypt, за да може да използвате функциите за криптиране.',
  ...
  'CXCache requires PHP XCache extensions to be loaded.' => 'CXCache изисква да се зареди PHP допълнението XCache.',
  ...
  'File upload was stopped by extensions.' => 'Качването на файла е спряно от допълнението.',
