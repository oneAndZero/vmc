...
class Document extends CActiveRecord
{
    ...
    public function rules()
    {
        return array(
            ...
            array('title', 'match', 'pattern' => '/[А-я\w\s,\-]+/', 'message' => 'Недопустимые символы в названии'),
            ...
            array('obj_file', 'file', 'types' => 'jpg, gif, png, odt, xls, xlsx, doc, docx, ptt, pttx, bmp, rar, zip, txt', 'allowEmpty' => true),
        );
    }
