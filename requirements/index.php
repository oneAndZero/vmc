...
$requirements=array(
	...
	array(
		...
		$message),
	array(
		t('yii','Reflection extensions'),
		true,
		class_exists('Reflection',false),
		'<a href="http://www.yiiframework.com">Yii Framework</a>',
		''),
	array(
		t('yii','PCRE extensions'),
		true,
		extension_loaded("pcre"),
		'<a href="http://www.yiiframework.com">Yii Framework</a>',
		''),
	array(
		t('yii','SPL extensions'),
		true,
		extension_loaded("SPL"),
		'<a href="http://www.yiiframework.com">Yii Framework</a>',
		''),
	array(
		t('yii','DOM extensions'),
		false,
	...
	array(
		...
		''),
	array(
		t('yii','GD extensions with<br />FreeType support'),
		false,
		($message=checkGD()) === '',
		//extension_loaded('gd'),
...
function checkServerVar()
{
	...
	if(!empty($missing))
		return t('yii','$_SERVER does not have {vars}.',array('{vars}'=>implode(', ',(array)$missing)));
