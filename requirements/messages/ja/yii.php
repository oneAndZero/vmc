 ...
 */
return array (
  'GD extensions with<br />FreeType support'=>'GD拡張 (FreeTypeサポート)',
  ...
  'DOM extensions' => 'DOM拡張',
  'Either $_SERVER["REQUEST_URI"] or $_SERVER["QUERY_STRING"] must exist.' => '$_SERVER["REQUEST_URI"]か$_SERVER["QUERY_STRING"]が存在するべきです。',
  'Mcrypt extensions' => 'Mcrypt拡張',
  'Memcache extensions' => 'Memcache拡張',
  'PCRE extensions' => 'PCRE拡張',
  'PDO MySQL extensions' => 'PDO MySQL拡張',
  'PDO PostgreSQL extensions' => 'PDO PostgreSQL拡張',
  'PDO SQLite extensions' => 'PDO SQLite拡張',
  'PDO extensions' => 'PDO拡張',
  'PHP 5.1.0 or higher is required.' => 'PHP 5.1.0かそれ以上が必要です。',
  'PHP version' => 'PHP版数',
  'Reflection extensions' => 'Reflection拡張',
  'SOAP extensions' => 'SOAP拡張',
  'SPL extensions' => 'SPL拡張',
