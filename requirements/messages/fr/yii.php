...
return array (
  ...
  'GD extensions' => 'extensions GD',
  'Mcrypt extensions' => 'extensions Mcrypt',
  'Memcache extensions' => 'extensions Memcache',
  'PCRE extensions' => 'extensions PCRE',
  'PDO MySQL extensions' => 'extensions PDO MySQL',
  'PDO PostgreSQL extensions' => 'extensions PDO PostgreSQL',
  'PDO SQLite extensions' => 'extensions PDO SQLite',
  'PDO extensions' => 'extensions PDO',
  'PHP 5.1.0 or higher is required.' => 'PHP 5.1.0 ou supérieur est requis.',
  'PHP version' => 'Version de PHP',
  'Reflection extensions' => 'extensions Reflection',
  'SOAP extensions' => 'extensions SOAP',
  'SPL extensions' => 'extensions SPL',
  'This is required by encrypt and decrypt methods.' => 'Nécessaire pour les méthodes encrypt et decrypt.',
  'This is required if you are using MySQL database.' => 'Cette extensions est requise si vous utilisez une base de donnée MySQL.',
  'This is required if you are using PostgreSQL database.' => 'Cette extensions est requise si vous utilisez une base de donnée PostgreSQL.',
  'This is required if you are using SQLite database.' => 'Cette extensions est requise si vous utilisez une base de donnée SQLite.',
