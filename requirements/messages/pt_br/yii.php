 ...
 */
return array (
  'Ctype extensions' => 'extensão Ctype',
  'GD extensions with<br />FreeType support' => 'extensão GD com<br />suporte a FreeType',
  ...
  'DOM extensions' => 'extensão DOM',
  'Either $_SERVER["REQUEST_URI"] or $_SERVER["QUERY_STRING"] must exist.' => '$_SERVER["REQUEST_URI"] ou $_SERVER["QUERY_STRING"] é obrigatório.',
  'Mcrypt extensions' => 'extensão Mcrypt',
  'Memcache extensions' => 'extensão Memcache',
  'PCRE extensions' => 'extensão PCRE',
  'PDO MySQL extensions' => 'extensão PDO_MySQL',
  'PDO PostgreSQL extensions' => 'extensão PDO_PostgreSQL',
  'PDO SQLite extensions' => 'extensão PDO_SQLite',
  'PDO extensions' => 'extensão PDO',
  'PHP 5.1.0 or higher is required.' => 'PHP 5.1.0 ou mais recente é necessário.',
  'PHP version' => 'versão PHP',
  'Reflection extensions' => 'extensão Reflection',
  'SOAP extensions' => 'extensão SOAP',
  'SPL extensions' => 'extensão SPL',
